...
import { 
    ...
    LogOut, Menu, FileX, BookMarked, MessageSquare, User, FolderOpen
} from 'lucide-react';
                ...
                <main className="flex-1 p-4 md:p-8 max-w-4xl mx-auto w-full space-y-6">
                    ...
                    <div className="space-y-4">
                        {announcements.length === 0 ? (
                            <div className="p-12 text-center text-gray-500 flex flex-col items-center justify-center bg-white rounded-xl border border-gray-200 shadow-sm">
                                <div className="w-16 h-16 bg-[#DCE6F1] rounded-full flex items-center justify-center mb-4 text-[#1F3864]">
                                    <FolderOpen className="w-8 h-8" />
                                </div>
                                <h2 className="text-xl font-bold text-gray-900 mb-2">No announcements</h2>
                                <p className="text-gray-500 mb-6">There are currently no announcements to display.</p>
                            </div>
                        ) : (
